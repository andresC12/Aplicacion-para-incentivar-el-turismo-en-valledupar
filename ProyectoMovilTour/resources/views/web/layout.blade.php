<html lang="es">
@php
  $usuario = \App\Persona::find(session('id_persona'));
  if(!$usuario) exit;
@endphp
<head>
  ...
  <title>AS Tour Administrador</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        ...
        <div class="sidebar-brand-text mx-3">As Tour Admin</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('sitio/index') }}">Sitios</a>
            <a class="collapse-item" href="{{ route('evento/index') }}">Eventos</a>
            <a class="collapse-item" href="{{ route('actividad/index') }}">Actividades</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="https://images.assetsdelivery.com/compings_v2/alekseyvanin/alekseyvanin1705/alekseyvanin170500978.jpg">
              </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span> &copy; Universidad Popular del cesar </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
