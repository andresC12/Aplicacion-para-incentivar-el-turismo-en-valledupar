          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block">
                <center><img src="/imagenes/tourimagen_login.png" style="width: 350px; height: 350px; margin-left: 80px; margin-top: 90px;"></center>
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <br><br><br>
                  ...
                  <form class="user" method="POST">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="usuario" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address..." required>
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="clave" id="exampleInputPassword" placeholder="Password" required>
                    </div>
                    <div class="form-group">
